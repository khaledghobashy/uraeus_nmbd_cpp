...
public:
    ...
    std::vector<std::string> names {"ground", "rbr_uca", "rbl_uca", "rbr_lca", "rbl_lca", "rbr_upright", "rbl_upright", "rbr_upper_strut", "rbl_upper_strut", "rbr_lower_strut", "rbl_lower_strut", "rbr_tie_rod", "rbl_tie_rod", "rbr_hub", "rbl_hub"};
